...
# create a function named "lcm" which calculates a least common multiple (lcm) values of two numbers. 
def lcm(num1,num2):
...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", result1 = num1, result2 = num2, lcm = lcm(int(num1),int(num2)), developer_name = 'Robert')
    else:
        return render_template("result.html", developer_name = "Robert")
